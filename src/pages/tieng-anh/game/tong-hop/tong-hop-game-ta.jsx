        ...
        <div className="container pb-20">
                                    ...
                                    You will receive an exclusive photo set based on the rank you achieve:                                    
                                        <div className='flex flex-col gap-4'>
                                            <div className='flex  flex-col gap-4 md:border-none border-t pt-4'>
                                                <span className=''>Especially for this game, just being in the top 10 will get you a separate exclusive photo set:</span>
            ...
            <div className="mb-4">
                ...
                <div className="rounded-2xl shadow overflow-hidden">
                    ...
                    src="https://wordwall.net/embed/04f97578eaeb4beda506473ad935a79e?themeId=21&templateId=69&fontStackId=0"
