    ...
    return (
        <div className="container pb-20">
            <div className="mb-4">
                    ...
                    <h1 className="text-center text-3xl tracking-tight font-bold my-4">CHALLENGE GAME</h1>
            ...
            <FoodContent title="Gameplay instructions">
                        ...
                        <div>
                            <p>
                                <ul className="list-[disclosure-closed] pl-5">
                                    <li>
                                    Name in the game is the Gmail you use for this account: {data?.data?.email}
                                    </li>

                                    <li>
                                    You will receive an exclusive photo set based on the rank you achieve:                                    
                                        <div className='flex flex-col gap-4'>
                                            <div className='flex  flex-col gap-4 md:border-none border-t pt-4'>
                                                <span className=''>For ranks 4-10, you will receive a photo set:</span>
                                            ...
                                            <div className='flex  flex-col gap-4 md:border-none border-t pt-4'>
                                                <span className=''>For ranks 1-3, you will receive a photo set:</span>
                                    ...
                                    <li className='mt-4'>
                                    Finally, wish you a fun and lucky gaming experience!
                                    </li>
                                </ul>
                            </p>
                        </div>
            ...
            <div className="mb-4">
                ...
                <div className="rounded-2xl shadow overflow-hidden">
                    ...
                    src="https://wordwall.net/embed/fc49e89213734e9a966bf8eb1f659d5e?themeId=21&templateId=69&fontStackId=0"
...
export default NUOCMAMRUOIGAMETA;
