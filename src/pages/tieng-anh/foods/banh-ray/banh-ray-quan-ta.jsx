...
const BANHRAYQUANTA = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.Minh Tri Elementary School Bánh Rây">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Trần Phú Street, Ward 7, Trà Vinh City, Trà Vinh Province (Opposite Nguyen 2 Coffee Shop).</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/t7PP0YBcR6M?list=PLO4xYQBA1oxVtcQx91K4UbaY5yQiwcARE"
                            title="Review Bánh Rây"
                            frameborder="0"
            ...
            <FoodContent title="2.The Historical Site Bà Om Pond">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">Address: </span>
                            <span>Ward 8, Trà Vinh City, Trà Vinh Province.</span>
                        </div>
                        <div className="mt-4">
