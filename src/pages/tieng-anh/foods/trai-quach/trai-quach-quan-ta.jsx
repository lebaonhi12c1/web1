        ...
        <div className="container pb-20">
            ...
            <FoodContent title="1.Trà Vinh Market">
                <div className="flex flex-col gap-4">
                    <div>
                        <p>
                        The wood apples are often sold at street stalls around the market. Furthermore, the wood apples are often sold in sidewalk areas and along the roadside.
                        </p>
                    </div>
                    <div>
                        <div>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/tgoF2qa8xWk?list=PLO4xYQBA1oxVp9yMDErgwbDnEAVTYTX_-"
                            title="Review Wood Apples"
                            frameborder="0"
                        ...
                        <iframe
                            ...
                            title="Sinh tố trái quách, Say nắng nụ cười cụ U72- Món ăn yêu thương tập 3 | Huyền Phi Official"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
                        ></iframe>
                            
                            <small className="italic block text-center">Source: excerpt from the YouTube channel: "Huyền Phi Official"</small>
                        </div>
                    </div>
                </div>
            </FoodContent>
...
export default TRAIQUACHQUANTA;
