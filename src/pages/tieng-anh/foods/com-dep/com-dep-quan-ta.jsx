...
const COMDEPQUANTA = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.Ba So Sweet Rice Flakes Village">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Nhị Trường Commune, Cầu Ngang District, Trà Vinh Province.</span>
                        </div>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/Z9_iKAHvltw?list=PLO4xYQBA1oxXfk9akdmDMZn-a-5U8OrHu"
                            title="Review of Sweet Rice Flakes at Ba So Village"
                            frameborder="0"
            ...
            <FoodContent title="2.Hai Lý">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">Address: </span>
                            <span> National Highway 53, Trà Cuon hamlet, Kim Hòa commune, Cầu Ngang District, Trà Vinh Province.</span>
                        </div>
                        <div className="mt-4">
