                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>19-5 Street, Ward 7, Trà Vinh City, Trà Vinh Province.</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/X1j-NU0_VL0?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                            title="Review of Bún Nước Lèo at Cô Ba 1"
                            frameborder="0"
                        ...
                        <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/3gSIIGsg68g?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                            title="Review of Bún Nước Lèo at Cô Ba 2"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
                        ></iframe>
            ...
            <FoodContent title="2.Bún Nước Lèo Dũng Chưởng">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">Address: </span>
                            <span>Đồng Khởi Street, Ward 6, Trà Vinh City, Trà Vinh Province.</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/zxJQmxmZ3sk?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                            title="Review of Bún Nước Lèo at Dũng Chưởng 1"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
                        ></iframe>
                        <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/Tzze90RFsgU?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                            title="Review of Bún Nước Lèo at Dũng Chưởng 2"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
                        ></iframe>
...
export default BUNNUOCLEOQUANTA;
