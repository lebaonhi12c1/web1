...
const CHAOAMQUANTA = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.Vân Anh Restaurant">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Thạch Thị Thanh Street, Sub-village 6, Ward 8, Trà Vinh City, Trà Vinh Province.</span>
                        </div>
                        <div className="mt-4">
            ...
            <FoodContent title="2.Snakehead Fish Porridge Restaurant">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">Address: </span>
                            <span>Trì Phong Hamlet, Hoà Lợi Commune, Châu Thành District, Trà Vinh Province.</span>
                        </div>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/0uiJvqat7ic?list=PLO4xYQBA1oxU8Wh7CFDOoIq3broDVrOX3"
                            title="Review Cháo Ám"
                            frameborder="0"
