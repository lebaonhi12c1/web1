...
const CHAHOAQUANTA = () => {
    ...
    return (
        <div className="container pb-20">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>44 Phạm Thái Bường, Ward 3, Trà Vinh City, Trà Vinh Province.</span>
                        </div>
                        <div className="mt-4">
            ...
            <FoodContent title="2.Other Places">
                <div className="flex flex-col gap-4">
                    <div>
                        <p>
                        "Chả hoa" from Trà Vinh can be purchased at local markets, supermarkets, or specialty stores in Trà Vinh, such as 
                            {' '}{highlightText(`Trà Vinh Market`)}.
                        </p>
                    </div>
