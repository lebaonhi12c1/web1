    ...
    return (
        <div className="container pb-20">
            <div className="mb-4">
                    ...
                    <h1 className="text-center text-3xl tracking-tight font-bold my-4">ល្បែងប្រឈម</h1>
            ...
            <FoodContent title="របៀបលេងល្បេង">
                        ...
                        <div>
                            <p>
                                <ul className="list-[disclosure-closed] pl-5">
                                    <li>
                                    កំណត់ឈ្មោះនៅក្នុងល្បែងទៅ Gmail ដែលអ្នកប្រើនៅក្នុងគណនីនេះ។ {data?.data?.email}
                                    </li>

                                    <li>
                                    អ្នក​នឹង​ទទួល​បាន​សំណុំ​រូបថត​ពិសេស​មួយ​អាស្រ័យ​លើ​ចំណាត់ថ្នាក់​ដែល​អ្នក​សម្រេច​បាន៖                                  
                                        <div className='flex flex-col gap-4'>
                                            <div className='flex  flex-col gap-4 md:border-none border-t pt-4'>
                                                <span className=''>សម្រាប់ចំណាត់ថ្នាក់លេខ 4-10 អ្នកនឹងទទួលបានរូបថតមួយឈុត៖</span>
                                            ...
                                            <div className='flex  flex-col gap-4 md:border-none border-t pt-4'>
                                                <span className=''>សម្រាប់ចំណាត់ថ្នាក់លេខ 1-3 អ្នកនឹងទទួលបានរូបថតមួយឈុត៖</span>
                                            ...
                                            {/* <div className='flex  flex-col gap-4 md:border-none border-t pt-4'>
                                                <span className=''>ជាពិសេសជាមួយនឹងល្បែងនេះ ដរាបណាអ្នកស្ថិតក្នុងកំពូលទាំង 10 អ្នកនឹងទទួលបានមួយឈុតរូបថតនៃសិទ្ធិពិសេស៖</span>
                                                <ul className="list-none flex-wrap flex items-center gap-4">
                                                {
                                                    imageIconDefault['best']?.map((item, index) => {
                                                        return (
                                                            <li key={index}>
                                                                <img src={item} alt="image-icon" className='w-10 h-10 rounded-full border border-gray-700' />
                                                            </li>
                                    ...
                                    <li className='mt-4'>
                                    ជាចុងក្រោយ សូមរីករាយ និងសំណាងល្អក្នុងការលេងល្បែង!
                                    </li>
                                </ul>
                            </p>
                        </div>
            ...
            <div className="mb-4">
                ...
                <div className="rounded-2xl shadow overflow-hidden">
                    ...
                    src="https://wordwall.net/embed/9756fcdd5ac74361b4f9b9ca5e1a517e?themeId=21&templateId=69&fontStackId=0"
...
export default NUOCMAMRUOIGAMEKM;
