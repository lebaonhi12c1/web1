...
const CHAHOAQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.Cha Hoa Nam Thuy">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>៤៤ Pham Thai Buong, សង្កាត់ទី ៣, ក្រុង Tra Vinh,  ខេត្ត Tra Vinh។</span>
                        </div>
                        <div className="mt-4">
            ...
            <FoodContent title="2.កន្លែងផ្សេងទៀត">
                <div className="flex flex-col gap-4">
                    <div>
                        <p>
                        កម្រងផ្កាត្រាវិញអាចរកទិញបាននៅផ្សារ ផ្សារទំនើប ឬហាងពិសេសនានាក្នុងខេត្តត្រាវិញ ជាទូទៅ{highlightText(`ផ្សារត្រាវិញ។`)}
                        </p>
                    </div>
