...
const CHAOAMQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.ភោជនីយដ្ឋាន Van Anh">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Thach Thi Thanh ភូមិ៦ សង្កាត់ទី៨ ក្រុងTra Vinh ខេត្ត Tra Vinh </span>
                        </div>
                        <div className="mt-4">
                            <iframe className="w-full h-auto aspect-square border-4 border-gray-600 rounded-xl overflow-hidden" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3930.224689662977!2d106.30624287479245!3d9.915235790185866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a017a9fe203f83%3A0x940261b2cf44ee4b!2zUXXDoW4gY2jDoW8gY8OhIGzDs2MgVsOibiBBbmg!5e0!3m2!1svi!2s!4v1703594669663!5m2!1svi!2s" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <FoodContent title="2.ភោជនីយដ្ឋាន Chao Ca Loc">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋាន៖ </span>
                            <span>ភូមិTri Phong ឃុំ Hoa Loi ស្រុក Chau Thanh  ខេត្ត Tra Vinh</span>
                        </div>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/LfHEJvrwa_8?list=PLO4xYQBA1oxU8Wh7CFDOoIq3broDVrOX3"
