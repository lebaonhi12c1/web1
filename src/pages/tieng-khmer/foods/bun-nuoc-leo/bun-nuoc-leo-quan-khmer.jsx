...
const BUNNUOCLEOQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.នំបញ្ចុកទឹកសម្ល Co Ba">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>ផ្លូវ ១៩-៥ ភូមិ ៨ សង្កាត់៧ ក្រុងត្រាវិញ ខេត្តត្រាវិញ</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/Hvd8N8jJ_64?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                        ...
                        <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/mID66L0l15Y?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                            title="Thuyết trình về món Bánh canh Bến Có"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
            ...
            <FoodContent title="2.នំបញ្ចុកទឹកសម្ល Dung Chuong">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋានៈ </span>
                            <span>ផ្លូវដុងខូយ សង្កាត់ ៦ ក្រុងត្រាវិញ ខេត្តត្រាវិញ</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/SDlku44DAEg?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                            title="Thuyết trình về món Bánh canh Bến Có"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
                        ></iframe>
                            <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/FMdQsFkvxHw?list=PLO4xYQBA1oxWIkVTOcy5cPvi4Jxyfgp75"
                            title="Thuyết trình về món Bánh canh Bến Có"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
...
export default BUNNUOCLEOQUANKM;
