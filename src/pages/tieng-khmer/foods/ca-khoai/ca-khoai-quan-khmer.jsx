...
const CAKHOAIQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            <div className="mb-4">
            <h1 className="text-center text-4xl tracking-tight font-bold my-4">អាហារពេលល្ងាចដ៏ល្បីល្បាញ</h1>
            ...
            <FoodContent title="1.ភោជនីយដ្ឋាន Trinh Lau Ca Khoai">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Truong Van Kinh សង្កាត់ទ១, ក្រុងTra Vinh, ខេត្តTra Vinh</span>
                        </div>
                        <div className="mt-4">
            ...
            <FoodContent title="2.ភោជនីយដ្ឋាន ៦៧">
                <div className="flex flex-col gap-4">
                    <div>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋាន៖ </span>
                            <span>សង្កាត់ទី១ ក្រុងTra Vinh ខេត្តTra Vinh</span>
                        </div>
                        <div className="mt-4">
