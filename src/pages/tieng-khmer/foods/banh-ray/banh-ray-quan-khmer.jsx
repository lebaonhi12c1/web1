...
const BANHRAYQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            <div className="mb-4">
            <h1 className="text-center text-4xl tracking-tight font-bold my-4">ហាងលុងល្បី</h1>
            ...
            <FoodContent title="1. លំអងចេក មុខសាលា Minh Tri">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>ថីត្រឹនភូ សង្កាត់ទី៧ ទីក្រុងត្រាវិញ ខេត្តត្រាវិញ (ទល់មុខហាងកាហ្វេង្វៀន ២)</span>
                        </div>
                        <div className="mt-4">
                            <iframe className="w-full h-auto aspect-square border-4 border-gray-600 rounded-xl overflow-hidden" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d245.62519038401945!2d106.33812380488962!3d9.933703530677754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a017516d22d64d%3A0x9da98809decdbdd2!2zUXXDoW4gQ2FmZSBOZ3V5w6puIDI!5e0!3m2!1svi!2s!4v1703577419497!5m2!1svi!2s"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/9uMV6QkjPU0?list=PLO4xYQBA1oxVtcQx91K4UbaY5yQiwcARE"
            ...
            <FoodContent title="2. រមណីយដ្ឋានគូស្រះស្រី">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋាន៖ </span>
                            <span>សង្កាត់ទី៨ ទីក្រុងត្រាវិញ ខេត្តត្រាវិញ</span>
                        </div>
                        <div className="mt-4">
                            <iframe className="w-full h-auto aspect-square border-4 border-gray-600 rounded-xl overflow-hidden" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1965.0918708655279!2d106.30879841649032!3d9.91865020977894!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0171f20bc97cb%3A0x6c42101d0d79f10d!2zQW8gQsOgIE9t!5e0!3m2!1svi!2s!4v1703577490752!5m2!1svi!2s"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
