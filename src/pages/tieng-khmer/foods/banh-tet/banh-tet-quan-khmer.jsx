...
const BANHTETQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            <div className="mb-4">
            <h1 className="text-center text-4xl tracking-tight font-bold my-4">ហាងលុកល្បី</h1>
            ...
            <FoodContent title="1.នំអន្សមជ្រូក Tra Cuon Hai Ly">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>ផ្លូវជាតិលេខ៥៣ ភូមិ Tra Cuon  ឃុំ Kim Hoa ស្រុក Cau Ngang  Tra Vinh ។</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/gxWZuHsYDZ8?list=PLO4xYQBA1oxVCO7kROjhPy_Y2QU7Yep49"
            ...
            <FoodContent title="2.នំអន្សមជ្រូក Tra Cuon Phuc Loc">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋាន៖ </span>
                            <span>ផ្លូវលេខ៦០ ឃុំ Dai Phuoc ស្រុក Cang Long ខេត្ត Tra Vinh។</span>
                        </div>
                            ...
                            វិធីសាស្ត្រទី 1: កម្ម៉ង់អាហារតាមរយៈសេវាកម្{' '}
                                ...
                                <div>
                                    <ul className="list-none">
                                        ...
                                        <li>
                                        ហ្វេសប៊ុក៖ ស្វែងរក {highlightText(`"អ្នកដឹកជញ្ជូន" `)}នៅក្នុង {highlightText(`"ទំព័រ"`)} ហើយចុចប៊ូតុង{' '}
                                            {highlightText(`"សារ"`)} ដើម្បីផ្ញើជួរហើយកម្ម៉ង់អីវ៉ាន់។
                                        </li>
                                    </ul>    
                                </div>
                            ...
                            វិធីសាស្រ្តទី 2: កម្ម៉ង់អាហារតាមរយៈសេវាកម្{' '}
                                ...
                                <div>
                                    <ul className="list-none">
                                        ...
                                        <li>
                                        ហ្វេសប៊ុក: ស្វែងរក {highlightText(`"អ្នកដឹកជញ្ជូន ត្រាវិញ" `)} នៅក្នុង {highlightText(`"ទំព័រ" `)} ហើយចុចលើប៊ូតុង{' '}
                                            {highlightText(`"សារ" `)} ដើម្បីផ្ញើជួរហើយកម្ម៉ង់អីវ៉ាន់។
                                        </li>
                                    </ul>
                    ...
                    <div>
                        ...
                        <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/uSZVgeT_tjA?list=PLO4xYQBA1oxVCO7kROjhPy_Y2QU7Yep49"
                            title="Thuyết trình về món Bánh canh Bến Có"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
