...
const BUNSUONGQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            <div className="mb-4">
            <h1 className="text-center text-4xl tracking-tight font-bold my-4">ហាងលុកល្បីល្បាញ</h1>
            ...
            <FoodContent title="1. ប៊ុនសួង Du Van">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>៦៤៤ Vo Nguyen Giap ភូមិ១ សង្កាត់ ៨ ក្រុងTra Vinh ខេត្ត Tra Vinh.</span>
                        </div>
                        <div className="mt-4">
                            <iframe
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-4">
                            <iframe
                                ...
                                src="https://www.youtube.com/embed/pywZFbch8ts?list=PLO4xYQBA1oxWOFFUkwDngz78iTEFjkoIg"
                                title="Review ប៊ុនសួង Du Van 1"
                                frameborder="0"
                            ...
                            <iframe
                                className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                                src="https://www.youtube.com/embed/X8BN7necCIM?list=PLO4xYQBA1oxWOFFUkwDngz78iTEFjkoIg"
                                title="Review ប៊ុនសួង Du Van 2"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen
                            ></iframe>
            ...
            <FoodContent title="2.ឈ្មោះ ប៊ុន សួង ហ៊ុយយ៉េន">
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                        <span className="font-semibold self-baseline">កូដ QR របស់ Facebook</span>
                        <div className="flex justify-center">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋាន៖ </span>
                            <span>ផ្ទះលេខ 56/4 Hung Vuong ភូមិ 3 សង្កាត់ 4 ក្រុង Tra Vinh ខេត្ត Tra Vinh</span>
                        </div>
                        <div className="mt-4">
                            <iframe
                                className="w-full h-auto aspect-square border-4 border-gray-600 rounded-xl overflow-hidden"
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-4">
                            <iframe
                                className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                                src="https://www.youtube.com/embed/ew4xGVcDxzQ?list=PLO4xYQBA1oxWOFFUkwDngz78iTEFjkoIg"
                                title="Review ប៊ុន សួង Hui Yen 1"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen=""
                            ></iframe>
