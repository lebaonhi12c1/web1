        ...
        <div className="container pb-20">
            ...
            <FoodContent title="1.Huyen Phi">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <p>
                        មិនថាទីជិត ឬឆ្ងាយ ប្រសិនបើអ្នកចង់រីករាយជាមួយអាហារអាចសាកល្បងផ្ញើសារដើម្បីបញ្ជាតាមរយៈ៖
                        </p>
                        <ul className="list-[disclosure-closed] pl-5">
                            <li>
                            វិធីសាស្ត្រទី 1: {highlightText(`Facebook`)}, {highlightText(`Tiktok`)} Huyen Phi ដូចខាងលើ
                            </li>
                            <li>
                            វិធីសាស្រ្តទី 2: លេខទូរស័ព្ទ៖ <CallTo phonenumber="0989 52 9949"/>       
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <FoodContent title="2.ដូងខ្ទិះBa Thuy ">
                <div className="flex flex-col gap-4">
               
                    <div>
                        <p>លេខទូរស័ព្ទ៖ <CallTo phonenumber="036 218 0559" /></p>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋាន៖  </span>
                            <span>ឃុំ Hoa Tan, Cau Ke, ខេត្ត Tra Vinh</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/UEvCZTcySdM?list=PLO4xYQBA1oxWEFlhmVAXkvvoPRKnUFdAF"
