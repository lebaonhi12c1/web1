...
const TRAIQUACHQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.ផ្សារ Tra Vinh">
                <div className="flex flex-col gap-4">
                    <div>
                        <p>
                        ផ្លែឈើនេះច្រើនតែលក់នៅតាមអាជីវករនៅជុំវិញផ្សារ។ លើសពីនេះទៀត ផ្លែឈើត្រូវបានគេលក់ជាញឹកញាប់នៅតាមចិញ្ចើមផ្លូវ និងតាមផ្លូវ។
                        </p>
                    </div>
                    <div>
                        <div>
                            <span className="font-semibold">អាស័យដ្ឋានៈ  </span>
                            <span>សង្កាត់ទី៣ ក្រុង Tra Vinh ខេត្ត Tra Vinh។</span>
                        </div>
                        <div className="mt-4">
                            <iframe className="w-full h-auto aspect-square border-4 border-gray-600 rounded-xl overflow-hidden" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7859.969727800556!2d106.34322600000002!3d9.935217!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a017543aee1d03%3A0xd4993464099847f5!2zQ2jhu6MgVHLDoCBWaW5oLCBQaMaw4budbmcgMywgVHLDoCBWaW5oLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2sus!4v1703610786104!5m2!1svi!2sus"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/PyhBMukHdro?list=PLO4xYQBA1oxVp9yMDErgwbDnEAVTYTX_-"
                        ...
                        <iframe
                            className="w-full h-auto aspect-video border-4 border-gray-600 rounded-xl overflow-hidden"
                            src="https://www.youtube.com/embed/IpIrvQBFfhY"
                            title="Thuyết trình về món Bánh canh Bến Có"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen=""
                        ></iframe>
                            ...
                            <small className="italic block text-center">ប្រភព៖ ដកស្រង់ចេញពី YouTube Channel៖ Huyền Phi Official</small>
                        </div>
                    </div>
                </div>
            </FoodContent>
...
export default TRAIQUACHQUANKM;
