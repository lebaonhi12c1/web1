...
const COMDEPQUANKM = () => {
    ...
    return (
        <div className="container pb-20">
            <div className="mb-4">
            <h1 className="text-center text-4xl tracking-tight font-bold my-4">ហាងលុកអាហារល្បី</h1>
            ...
            <FoodContent title="1.ភូមិអំបុក Ba So">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>ឃុំ Nhi Truong ស្រុក Cau Ngang ខេត្ត Tra Vinh</span>
                        </div>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/qYQTQXYJHuI?list=PLO4xYQBA1oxXfk9akdmDMZn-a-5U8OrHu"
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>ផ្លូវជាតិលេខ ៥៣ ភូមិTra Cuon ឃុំ kim Hoa ស្រុក Cau Ngang ខេត្តTra Vinh</span>
                        </div>
                        <div className="mt-4">
                            <iframe className="w-full h-auto aspect-square border-4 border-gray-600 rounded-xl overflow-hidden" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d982.7242088146639!2d106.414585!3d9.859022!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a017fbdc2fa74f%3A0x77c77ebcf383e634!2zQsOhbmggdMOpdCBIYWkgTMO9!5e0!3m2!1svi!2sus!4v1703604771837!5m2!1svi!2sus" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
